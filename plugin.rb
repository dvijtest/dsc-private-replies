# name: dsc-private-replies
# about: Private Replies Plugin
# version: 0.2
...
after_initialize do
  ...
  # Register custom field for private replies for topics
  ...
  # Register custom field for private replies for individual posts
  Post.register_custom_field_type('private_replies', :boolean)
  add_to_serializer :post, :private_replies do
    object.custom_fields['private_replies']
  end
